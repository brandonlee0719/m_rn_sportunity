...
class ClubSteps extends Component {
  render() {
      ...
      <View>
        {!user.isSubAccount && 
          <StepsListItem
            ...
            headingText={I18n.t('stepper_modal_club_create_teams')}
            description={I18n.t('stepper_modal_club_create_teams_description_1') + I18n.t('stepper_modal_club_create_teams_description_2')}
        ...
        <StepsListItem
          ...
          headingText={I18n.t('stepper_modal_club_give_access')}
          description={I18n.t('stepper_modal_club_give_access_description_1')}
        ...
        <StepsListItem
          ...
          headingText={I18n.t('stepper_modal_club_create_group')}
          description={I18n.t('stepper_modal_club_create_group_description_1')}
        ...
        <StepsListItem
          ...
          headingText={I18n.t('stepper_modal_club_organize_activity')}
          description={I18n.t('stepper_modal_club_organize_activity_description_1')}
        ...
        <StepsListItem
          ...
          headingText={I18n.t('stepper_modal_club_stats')}
          description={I18n.t('stepper_modal_club_stats_description_1')}
        ...
        <StepsListItem
          ...
          headingText={I18n.t('stepper_modal_club_form')}
          description={I18n.t('stepper_modal_club_form_description_1')}
        ...
        <StepsListItem
          ...
          headingText={I18n.t('stepper_modal_club_subscription')}
          description={I18n.t('stepper_modal_club_subscription_description_1')}
          onPress={showUnavailableToast}
        ...
        <StepsListItem
          ...
          headingText={I18n.t('stepper_modal_club_documents')}
          description={I18n.t('stepper_modal_club_documents_description_1')}
          onPress={showUnavailableToast}
