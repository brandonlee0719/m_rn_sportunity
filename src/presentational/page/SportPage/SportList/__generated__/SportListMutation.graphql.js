/**
 * @flow
 * @relayHash 6ea1dac7afb587730eef6bd08f729614
 */
...
export type SportListMutationVariables = {|
  input: upUserInput
|};
export type SportListMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +user: ?{|
      +id: string,
  ...
  |}
|};
export type SportListMutation = {|
  variables: SportListMutationVariables,
  response: SportListMutationResponse,
|};
*/


/*
mutation SportListMutation(
  $input: upUserInput!
) {
  upUser(input: $input) {
    clientMutationId
...
return {
  ...
  "name": "SportListMutation",
  "id": null,
  "text": "mutation SportListMutation(\n  $input: upUserInput!\n) {\n  upUser(input: $input) {\n    clientMutationId\n    user {\n      id\n      isPublicProfileComplete\n      sports {\n        sport {\n          id\n          name {\n            id\n            EN\n            FR\n          }\n          logo\n          positions {\n            id\n            EN\n            FR\n          }\n          certificates {\n            id\n            name {\n              id\n              EN\n              FR\n            }\n          }\n          levels {\n            id\n            EN {\n              name\n              description\n              skillLevel\n            }\n            FR {\n              name\n              description\n              skillLevel\n            }\n          }\n        }\n        positions {\n          id\n          EN\n          FR\n        }\n        certificates {\n          validation\n          certificate {\n            id\n            name {\n              id\n              EN\n              FR\n            }\n          }\n        }\n        levels {\n          id\n          EN {\n            name\n            description\n            skillLevel\n          }\n          FR {\n            name\n            description\n            skillLevel\n          }\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "SportListMutation",
...
// prettier-ignore
(node/*: any*/).hash = 'c1caeedad72b6cbc5e497471ebed2118';
module.exports = node;
