...
declare export opaque type SportList_sports$ref: FragmentReference;
export type SportList_sports = $ReadOnlyArray<{|
  +sport: ?{|
    +id: string,
    +name: ?{|
      +id: string,
...
// prettier-ignore
(node/*: any*/).hash = '4ee239df2ed7e349f6ae2ed2e4d508fe';
module.exports = node;
