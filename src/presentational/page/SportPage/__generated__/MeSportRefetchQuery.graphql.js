/**
 * @flow
 * @relayHash ea8a0601128fa5e010747634eeed48c6
 */
...
export type MeSportRefetchQueryVariables = {|
  querySports: boolean,
  count?: ?number,
  sportFilter?: ?SportFilter,
|};
export type MeSportRefetchQueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: MeSport_viewer$ref
  |}
|};
export type MeSportRefetchQuery = {|
  variables: MeSportRefetchQueryVariables,
  response: MeSportRefetchQueryResponse,
|};
*/


/*
query MeSportRefetchQuery(
  $querySports: Boolean!
  $count: Int
  $sportFilter: SportFilter
) {
  viewer {
    ...MeSport_viewer_9st2p
    id
  }
}

fragment MeSport_viewer_9st2p on Viewer {
  id
  me {
    id
    sports {
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "MeSportRefetchQuery",
  "id": null,
  "text": "query MeSportRefetchQuery(\n  $querySports: Boolean!\n  $count: Int\n  $sportFilter: SportFilter\n) {\n  viewer {\n    ...MeSport_viewer_9st2p\n    id\n  }\n}\n\nfragment MeSport_viewer_9st2p on Viewer {\n  id\n  me {\n    id\n    sports {\n      ...SportList_sports\n    }\n  }\n  sports(first: $count, filter: $sportFilter) @include(if: $querySports) {\n    ...SportList_allSports\n  }\n}\n\nfragment SportList_sports on SportDescriptor {\n  sport {\n    id\n    name {\n      id\n      EN\n      FR\n    }\n    logo\n    positions {\n      id\n      EN\n      FR\n    }\n    certificates {\n      id\n      name {\n        id\n        EN\n        FR\n      }\n    }\n    levels {\n      id\n      EN {\n        name\n        description\n        skillLevel\n      }\n      FR {\n        name\n        description\n        skillLevel\n      }\n    }\n  }\n  positions {\n    id\n    EN\n    FR\n  }\n  certificates {\n    validation\n    certificate {\n      id\n      name {\n        id\n        EN\n        FR\n      }\n    }\n  }\n  levels {\n    id\n    EN {\n      name\n      description\n      skillLevel\n    }\n    FR {\n      name\n      description\n      skillLevel\n    }\n  }\n}\n\nfragment SportList_allSports on SportConnection {\n  edges {\n    node {\n      id\n      name {\n        id\n        EN\n        FR\n      }\n      logo\n      positions {\n        id\n        EN\n        FR\n      }\n      certificates {\n        id\n        name {\n          id\n          EN\n          FR\n        }\n      }\n      levels {\n        id\n        EN {\n          name\n          description\n          skillLevel\n        }\n        FR {\n          name\n          description\n          skillLevel\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "MeSportRefetchQuery",
...
// prettier-ignore
(node/*: any*/).hash = '8ba88ae223ad2ff7b7275536d0fc6ec7';
module.exports = node;
