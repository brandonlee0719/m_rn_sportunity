...
declare export opaque type MeSport_viewer$ref: FragmentReference;
export type MeSport_viewer = {|
  +id: string,
  +me: ?{|
    +id: string,
...
// prettier-ignore
(node/*: any*/).hash = 'a660da9a0493bb1dfdc3182cfdc831d2';
module.exports = node;
