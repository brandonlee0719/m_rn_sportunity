/**
 * @flow
 * @relayHash 1e16a8cf43b83af692699df8a28e8763
 */
...
export type PublicCirclesFilterRefetchQueryVariables = {|
  querySports: boolean,
  count?: ?number,
  sportFilter?: ?SportFilter,
|};
export type PublicCirclesFilterRefetchQueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: PublicCirclesFilter_viewer$ref
  |}
|};
export type PublicCirclesFilterRefetchQuery = {|
  variables: PublicCirclesFilterRefetchQueryVariables,
  response: PublicCirclesFilterRefetchQueryResponse,
|};
*/
...
query PublicCirclesFilterRefetchQuery(
  ...
  viewer {
    ...PublicCirclesFilter_viewer_9st2p
    id
  }
}

fragment PublicCirclesFilter_viewer_9st2p on Viewer {
  id
  me {
    id
    sports {
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "PublicCirclesFilterRefetchQuery",
  "id": null,
  "text": "query PublicCirclesFilterRefetchQuery(\n  $querySports: Boolean!\n  $count: Int\n  $sportFilter: SportFilter\n) {\n  viewer {\n    ...PublicCirclesFilter_viewer_9st2p\n    id\n  }\n}\n\nfragment PublicCirclesFilter_viewer_9st2p on Viewer {\n  id\n  me {\n    id\n    sports {\n      ...SportList_sports\n    }\n  }\n  sports(first: $count, filter: $sportFilter) @include(if: $querySports) {\n    ...SportList_allSports\n  }\n}\n\nfragment SportList_sports on SportDescriptor {\n  sport {\n    id\n    name {\n      id\n      EN\n      FR\n    }\n    logo\n    positions {\n      id\n      EN\n      FR\n    }\n    certificates {\n      id\n      name {\n        id\n        EN\n        FR\n      }\n    }\n    levels {\n      id\n      EN {\n        name\n        description\n        skillLevel\n      }\n      FR {\n        name\n        description\n        skillLevel\n      }\n    }\n  }\n  positions {\n    id\n    EN\n    FR\n  }\n  certificates {\n    validation\n    certificate {\n      id\n      name {\n        id\n        EN\n        FR\n      }\n    }\n  }\n  levels {\n    id\n    EN {\n      name\n      description\n      skillLevel\n    }\n    FR {\n      name\n      description\n      skillLevel\n    }\n  }\n}\n\nfragment SportList_allSports on SportConnection {\n  edges {\n    node {\n      id\n      name {\n        id\n        EN\n        FR\n      }\n      logo\n      positions {\n        id\n        EN\n        FR\n      }\n      certificates {\n        id\n        name {\n          id\n          EN\n          FR\n        }\n      }\n      levels {\n        id\n        EN {\n          name\n          description\n          skillLevel\n        }\n        FR {\n          name\n          description\n          skillLevel\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "PublicCirclesFilterRefetchQuery",
...
// prettier-ignore
(node/*: any*/).hash = '6bd054dc67a7a3aaeaf3a8332b5caf66';
module.exports = node;
