/**
 * @flow
 * @relayHash 20c6c7281af617cf3900b5bf5d9ae10f
 */
...
export type LanguagesMutationVariables = {|
  input: upUserInput
|};
...
export type LanguagesMutation = {|
  variables: LanguagesMutationVariables,
  response: LanguagesMutationResponse,
|};
*/


/*
mutation LanguagesMutation(
  $input: upUserInput!
) {
  upUser(input: $input) {
    clientMutationId
...
return {
  ...
  "name": "LanguagesMutation",
  "id": null,
  "text": "mutation LanguagesMutation(\n  $input: upUserInput!\n) {\n  upUser(input: $input) {\n    clientMutationId\n    user {\n      id\n      languages {\n        id\n        code\n        name\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "LanguagesMutation",
...
// prettier-ignore
(node/*: any*/).hash = 'daa8cc76fb37b4fab29f0dde716d8e41';
module.exports = node;
