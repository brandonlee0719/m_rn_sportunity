/**
 * @flow
 * @relayHash 8f743533554670c188e32c763af518ed
 */
...
export type CirclesPageViewRefetchQueryVariables = {|
  queryPublic: boolean,
  ...
  circleNumber?: ?number,
|};
export type CirclesPageViewRefetchQueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: CirclesPageView_viewer$ref
  |}
|};
export type CirclesPageViewRefetchQuery = {|
  variables: CirclesPageViewRefetchQueryVariables,
  response: CirclesPageViewRefetchQueryResponse,
|};
*/
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "CirclesPageViewRefetchQuery",
  "id": null,
  "text": "query CirclesPageViewRefetchQuery(\n  $queryPublic: Boolean!\n  $queryMyCircles: Boolean!\n  $queryCirclesImIn: Boolean!\n  $queryCirclesSuperUser: Boolean!\n  $queryMain: Boolean!\n  $filter: CirclesFilter\n  $publicFilter: CirclesFilter\n  $myCirclesFilter: CirclesFilter\n  $circleNumber: Int\n) {\n  viewer {\n    ...CirclesPageView_viewer_Psykq\n    id\n  }\n}\n\nfragment CirclesPageView_viewer_Psykq on Viewer {\n  id\n  ...CirclesDetailPage_viewer\n  ...Stepper_viewer\n  circles(first: $circleNumber, filter: $publicFilter) @include(if: $queryMain) {\n    count\n    pageInfo {\n      hasNextPage\n    }\n    edges @include(if: $queryPublic) {\n      node {\n        id\n        ...CirclesItem_circle\n        isCircleUsableByMembers\n        owner {\n          id\n        }\n        coOwners {\n          id\n        }\n        members {\n          id\n        }\n        termsOfUses {\n          id\n          name\n          link\n          content\n          acceptedBy {\n            user {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n  me {\n    id\n    profileType\n    basicCircleSavedFiltersCreated\n    savedCircleFilters {\n      id\n      filterName\n      location {\n        lat\n        lng\n        radius\n      }\n      sport {\n        sport {\n          id\n          name {\n            EN\n            FR\n            id\n          }\n          levels {\n            id\n            EN {\n              name\n              description\n              skillLevel\n            }\n            FR {\n              name\n              description\n              skillLevel\n            }\n          }\n        }\n        levels {\n          id\n          EN {\n            name\n            description\n            skillLevel\n          }\n          FR {\n            name\n            description\n            skillLevel\n          }\n        }\n      }\n      circleType\n      memberTypes\n      modes\n      owners {\n        id\n        pseudo\n      }\n    }\n    defaultSavedCircleFilter {\n      id\n      filterName\n      sport {\n        sport {\n          id\n          name {\n            EN\n            FR\n            id\n          }\n          logo\n          levels {\n            id\n            EN {\n              name\n              description\n              skillLevel\n            }\n            FR {\n              name\n              description\n              skillLevel\n            }\n          }\n        }\n        levels {\n          id\n          EN {\n            name\n            description\n            skillLevel\n          }\n          FR {\n            name\n            description\n            skillLevel\n          }\n        }\n      }\n      location {\n        lat\n        lng\n        radius\n      }\n      circleType\n      memberType\n    }\n    subAccounts {\n      id\n    }\n    circles(last: 100, filter: $myCirclesFilter) @include(if: $queryMain) {\n      count\n      edges @include(if: $queryMyCircles) {\n        node {\n          ...CirclesItem_circle\n          id\n          owner {\n            id\n            avatar\n            pseudo\n          }\n          isCircleAccessibleFromUrl\n          mode\n          type\n          coOwners {\n            id\n          }\n          members {\n            id\n          }\n          memberParents {\n            id\n          }\n        }\n      }\n    }\n  circlesUserIsIn(last: 100, filter: $filter) @include(if: $queryMain) {\n      count\n      edges @include(if: $queryCirclesImIn) {\n        node {\n          ...CirclesItem_circle\n          isCircleAccessibleFromUrl\n          isCircleUsableByMembers\n          id\n        }\n      }\n    }\n  circlesSuperUser(last: 100, filter: $filter) @include(if: $queryMain) {\n      count\n      edges @include(if: $queryCirclesSuperUser) {\n        node {\n          ...CirclesItem_circle\n          isCircleAccessibleFromUrl\n          id\n        }\n      }\n    }\n  circlesFromClub(last: 100, filter: $filter) @include(if: $queryMain) {\n      count\n      edges @include(if: $queryCirclesSuperUser) {\n        node {\n          ...CirclesItem_circle\n          isCircleAccessibleFromUrl\n          id\n        }\n      }\n    }\n  }\n}\n\nfragment CirclesDetailPage_viewer on Viewer {\n  id\n  ...ChatDetailPageContainer_viewer\n  me {\n    id\n    pseudo\n    profileType\n    isSubAccount\n    ...AddMember_user\n    ...AddChild_user\n  }\n  chat {\n    id\n  }\n  circle: circle {\n    id\n    publicShortCode\n    name\n    mode\n    type\n    isCircleUpdatableByMembers\n    isCircleAccessibleFromUrl\n    isCircleUsableByMembers\n    sport {\n      sport {\n        id\n        name {\n          EN\n          FR\n          id\n        }\n      }\n      levels {\n        EN {\n          name\n        }\n        FR {\n          name\n        }\n        id\n      }\n    }\n    address {\n      address\n      zip\n      city\n      country\n    }\n    circlePreferences {\n      isChildrenCircle\n    }\n    owner {\n      id\n      pseudo\n      avatar\n    }\n    coOwners {\n      id\n    }\n    memberCount\n    members {\n      id\n      pseudo\n      email\n      firstName\n      lastName\n      avatar\n      lastConnexionDate\n    }\n    memberParents {\n      id\n      pseudo\n      avatar\n      lastConnexionDate\n    }\n    askedInformation {\n      id\n      name\n      type\n      filledByOwner\n    }\n    membersInformation {\n      id\n      information\n      user {\n        id\n      }\n      value\n    }\n    termsOfUses {\n      id\n      name\n      link\n      content\n      acceptedBy {\n        user {\n          id\n        }\n      }\n    }\n    ...CircleOptions_circle\n    ...CircleDetails_circle\n  }\n  ...CircleOptions_viewer\n  ...AddMember_viewer\n  ...Subscribe_viewer\n  ...AddChild_viewer\n}\n\nfragment Stepper_viewer on Viewer {\n  id\n  me {\n    id\n    profileType\n    mangoId\n    pseudo\n    tutorialSteps {\n      createFormStep\n      setupMembersSubscriptionStep\n      fulfilProfileStep\n      addOfficialDocumentsStep\n      createSubAccountStep\n      shareAccessStep\n      createCircleStep\n      organizeStep\n      setupStatisticsStep\n      joinAPrivateCircleStep\n      joinAPublicCircleStep\n      giveAvailabilitiesStep\n      bookSportunityStep\n    }\n    subAccounts {\n      id\n    }\n    isSubAccount\n  }\n}\n\nfragment CirclesItem_circle on Circle {\n  id\n  name\n  memberCount\n  mode\n  isCircleUsableByMembers\n  isCircleAccessibleFromUrl\n  type\n  owner {\n    id\n    avatar\n    pseudo\n  }\n  coOwners {\n    id\n  }\n  members {\n    id\n  }\n  memberParents {\n    id\n  }\n}\n\nfragment ChatDetailPageContainer_viewer on Viewer {\n  ...ChatDetailPage_viewer\n}\n\nfragment AddMember_user on User {\n  id\n  email\n  pseudo\n  profileType\n}\n\nfragment AddChild_user on User {\n  id\n  email\n  pseudo\n  subAccounts {\n    id\n    pseudo\n    avatar\n  }\n}\n\nfragment CircleOptions_circle on Circle {\n  id\n  description\n  mode\n  isCircleUpdatableByMembers\n  isCircleUsableByMembers\n  isCircleAccessibleFromUrl\n  sport {\n    sport {\n      id\n      name {\n        EN\n        FR\n        id\n      }\n    }\n    levels {\n      id\n      EN {\n        name\n      }\n      FR {\n        name\n      }\n    }\n  }\n  address {\n    address\n    zip\n    city\n    country\n  }\n  circlePreferences {\n    isChildrenCircle\n  }\n  askedInformation {\n    id\n    name\n    type\n    filledByOwner\n  }\n  membersInformation {\n    id\n    information\n    user {\n      id\n    }\n    value\n  }\n}\n\nfragment CircleDetails_circle on Circle {\n  id\n  description\n  type\n  mode\n  isCircleUsableByMembers\n  publicShortCode\n  address {\n    address\n    city\n    country\n    position {\n      lat\n      lng\n    }\n  }\n  sport {\n    sport {\n      id\n      logo\n      name {\n        EN\n        FR\n        id\n      }\n    }\n    levels {\n      id\n      EN {\n        name\n        skillLevel\n      }\n      FR {\n        name\n        skillLevel\n      }\n    }\n  }\n}\n\nfragment CircleOptions_viewer on Viewer {\n  id\n  ...AdminMembersInformation_viewer\n  ...CircleSport_viewer\n}\n\nfragment AddMember_viewer on Viewer {\n  id\n  ...SearchModule_viewer\n}\n\nfragment Subscribe_viewer on Viewer {\n  me {\n    id\n    pseudo\n    avatar\n  }\n}\n\nfragment AddChild_viewer on Viewer {\n  ...AddChildModal_viewer\n}\n\nfragment AddChildModal_viewer on Viewer {\n  id\n  ...CreateProfilePage_viewer\n}\n\nfragment CreateProfilePage_viewer on Viewer {\n  id\n  me {\n    id\n    pseudo\n    email\n    phoneNumber\n  }\n}\n\nfragment SearchModule_viewer on Viewer {\n  id\n  ...SportunityItem_viewer\n  ...FilterDetailSports_viewer\n  me {\n    id\n    profileType\n    ...SportunityItem_user\n  }\n  selectedCircle: circle {\n    id\n    name\n    owner {\n      id\n      pseudo\n      avatar\n    }\n    members {\n      id\n      pseudo\n      avatar\n      profileType\n    }\n    memberCount\n  }\n}\n\nfragment SportunityItem_viewer on Viewer {\n  ...TopContent_viewer\n}\n\nfragment FilterDetailSports_viewer on Viewer {\n  filterSport: sport {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n    logo\n    levels {\n      id\n      EN {\n        name\n      }\n      FR {\n        name\n      }\n    }\n  }\n}\n\nfragment SportunityItem_user on User {\n  ...TopContent_user\n  ...BottomContent_user\n}\n\nfragment TopContent_user on User {\n  id\n}\n\nfragment BottomContent_user on User {\n  id\n}\n\nfragment TopContent_viewer on Viewer {\n  id\n}\n\nfragment AdminMembersInformation_viewer on Viewer {\n  id\n}\n\nfragment CircleSport_viewer on Viewer {\n  id\n  me {\n    id\n    sports {\n      ...SportList_sports\n    }\n  }\n}\n\nfragment SportList_sports on SportDescriptor {\n  sport {\n    id\n    name {\n      id\n      EN\n      FR\n    }\n    logo\n    positions {\n      id\n      EN\n      FR\n    }\n    certificates {\n      id\n      name {\n        id\n        EN\n        FR\n      }\n    }\n    levels {\n      id\n      EN {\n        name\n        description\n        skillLevel\n      }\n      FR {\n        name\n        description\n        skillLevel\n      }\n    }\n  }\n  positions {\n    id\n    EN\n    FR\n  }\n  certificates {\n    validation\n    certificate {\n      id\n      name {\n        id\n        EN\n        FR\n      }\n    }\n  }\n  levels {\n    id\n    EN {\n      name\n      description\n      skillLevel\n    }\n    FR {\n      name\n      description\n      skillLevel\n    }\n  }\n}\n\nfragment ChatDetailPage_viewer on Viewer {\n  me {\n    id\n  }\n  ...MessagesList_viewer\n}\n\nfragment MessagesList_viewer on Viewer {\n  me {\n    id\n    pseudo\n    avatar\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "CirclesPageViewRefetchQuery",
...
// prettier-ignore
(node/*: any*/).hash = '53c05a5f0bdda82929019d37d0d27d5e';
module.exports = node;
