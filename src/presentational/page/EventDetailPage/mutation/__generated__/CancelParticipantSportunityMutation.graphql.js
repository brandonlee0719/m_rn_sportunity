/**
 * @flow
 * @relayHash 3392755919dbbe3b0377334120c34497
 */
...
export type CancelParticipantSportunityMutationVariables = {|
  input: updateSportunityInput
|};
export type CancelParticipantSportunityMutationResponse = {|
  +updateSportunity: ?{|
    +clientMutationId: ?string,
    +edge: ?{|
      +node: ?{|
  ...
  |}
|};
export type CancelParticipantSportunityMutation = {|
  variables: CancelParticipantSportunityMutationVariables,
  response: CancelParticipantSportunityMutationResponse,
|};
*/


/*
mutation CancelParticipantSportunityMutation(
  $input: updateSportunityInput!
) {
...
return {
  ...
  "name": "CancelParticipantSportunityMutation",
  "id": null,
  "text": "mutation CancelParticipantSportunityMutation(\n  $input: updateSportunityInput!\n) {\n  updateSportunity(input: $input) {\n    clientMutationId\n    edge {\n      node {\n        id\n        status\n        participants {\n          id\n          pseudo\n          avatar\n        }\n        waiting {\n          id\n          pseudo\n          avatar\n        }\n        willing {\n          id\n          pseudo\n          avatar\n        }\n        canceling {\n          canceling_user {\n            id\n            pseudo\n            avatar\n          }\n          status\n          cancelation_date\n        }\n        invited {\n          user {\n            id\n            pseudo\n            avatar\n          }\n          answer\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "CancelParticipantSportunityMutation",
...
// prettier-ignore
(node/*: any*/).hash = '5073846c466cd170e47829ea1d6e3b35';
module.exports = node;
