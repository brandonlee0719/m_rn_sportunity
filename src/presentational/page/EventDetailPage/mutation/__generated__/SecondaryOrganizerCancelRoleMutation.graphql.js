/**
 * @flow
 * @relayHash 748db457d67fbb6cff0fc46b6d81d0d9
 */
...
export type secondaryOrganizerCancelRoleInput = {
  sportunityID: string,
  cancelSerie?: ?boolean,
  clientMutationId?: ?string,
};
export type SecondaryOrganizerCancelRoleMutationVariables = {|
  input: secondaryOrganizerCancelRoleInput
|};
export type SecondaryOrganizerCancelRoleMutationResponse = {|
  +secondaryOrganizerCancelRole: ?{|
    +clientMutationId: ?string,
    +edge: ?{|
      +node: ?{|
  ...
  |}
|};
export type SecondaryOrganizerCancelRoleMutation = {|
  variables: SecondaryOrganizerCancelRoleMutationVariables,
  response: SecondaryOrganizerCancelRoleMutationResponse,
|};
*/
...
var v0 = [
  {
    "kind": "LocalArgument",
    "name": "input",
    "type": "secondaryOrganizerCancelRoleInput!",
    "defaultValue": null
  }
],
v1 = [
...
return {
  ...
  "name": "SecondaryOrganizerCancelRoleMutation",
  "id": null,
  "text": "mutation SecondaryOrganizerCancelRoleMutation(\n  $input: secondaryOrganizerCancelRoleInput!\n) {\n  secondaryOrganizerCancelRole(input: $input) {\n    clientMutationId\n    edge {\n      node {\n        organizers {\n          isAdmin\n          secondaryOrganizerType {\n            id\n            name {\n              FR\n              EN\n              DE\n              ES\n              id\n            }\n          }\n          customSecondaryOrganizerType\n          price {\n            cents\n            currency\n          }\n          organizer {\n            id\n            pseudo\n            sportunityNumber\n            feedbacks {\n              averageRating\n              count\n            }\n            sports {\n              levels {\n                EN {\n                  name\n                }\n                id\n              }\n            }\n            address {\n              address\n              country\n              city\n              zip\n              position {\n                lat\n                lng\n              }\n            }\n            avatar\n            followers {\n              id\n            }\n          }\n          permissions {\n            detailsAccess {\n              view\n              edit\n            }\n            chatAccess {\n              view\n              edit\n            }\n            memberAccess {\n              view\n              edit\n            }\n            carPoolingAccess {\n              view\n              edit\n            }\n            imageAccess {\n              view\n              edit\n            }\n            compositionAccess {\n              view\n              edit\n            }\n          }\n          ...ButtonFeedback_organizers\n          id\n        }\n        pendingOrganizers {\n          id\n          circles(last: 20) {\n            edges {\n              node {\n                id\n                members {\n                  id\n                }\n                name\n                memberCount\n              }\n            }\n          }\n          isAdmin\n          role\n          secondaryOrganizerType {\n            id\n            name {\n              FR\n              EN\n              DE\n              ES\n              id\n            }\n          }\n          customSecondaryOrganizerType\n          price {\n            cents\n            currency\n          }\n          permissions {\n            detailsAccess {\n              view\n              edit\n            }\n            chatAccess {\n              view\n              edit\n            }\n            memberAccess {\n              view\n              edit\n            }\n            carPoolingAccess {\n              view\n              edit\n            }\n            imageAccess {\n              view\n              edit\n            }\n            compositionAccess {\n              view\n              edit\n            }\n          }\n        }\n        status\n        id\n      }\n    }\n  }\n}\n\nfragment ButtonFeedback_organizers on Organizer {\n  isAdmin\n  organizer {\n    id\n    pseudo\n    feedbacks {\n      feedbacksList(last: 1000) {\n        edges {\n          node {\n            author {\n              id\n            }\n            id\n          }\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "SecondaryOrganizerCancelRoleMutation",
    ...
    "selections": [
      {
        "kind": "LinkedField",
        "alias": null,
        "name": "secondaryOrganizerCancelRole",
        "storageKey": null,
        "args": v1,
        "concreteType": "secondaryOrganizerCancelRolePayload",
        "plural": false,
        "selections": [
          v2,
          {
...
// prettier-ignore
(node/*: any*/).hash = '7e7afd7966393ae3aed371cd918ae1c1';
module.exports = node;
