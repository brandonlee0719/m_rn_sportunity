/**
 * @flow
 * @relayHash 4e654605d4bc9f1ab01d57c23d3f911c
 */
...
export type UpdateUserFeedbackMutationVariables = {|
  input: upUserInput
|};
export type UpdateUserFeedbackMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +user: ?{|
      +id: string,
...
export type UpdateUserFeedbackMutation = {|
  variables: UpdateUserFeedbackMutationVariables,
  response: UpdateUserFeedbackMutationResponse,
|};
*/


/*
mutation UpdateUserFeedbackMutation(
  $input: upUserInput!
) {
  upUser(input: $input) {
    clientMutationId
...
return {
  ...
  "name": "UpdateUserFeedbackMutation",
  "id": null,
  "text": "mutation UpdateUserFeedbackMutation(\n  $input: upUserInput!\n) {\n  upUser(input: $input) {\n    clientMutationId\n    user {\n      id\n      feedbacks {\n        feedbacksList(last: 1000) {\n          edges {\n            node {\n              author {\n                id\n              }\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "UpdateUserFeedbackMutation",
...
// prettier-ignore
(node/*: any*/).hash = '504cfc7a2fc1aab9d20ce4d1ddd9f4fc';
module.exports = node;
