/**
 * @flow
 * @relayHash 515d646b226262f6311a4bf35b97e37d
 */
...
export type RefuseInvitationMutationVariables = {|
  input: updateSportunityInput
|};
export type RefuseInvitationMutationResponse = {|
  +updateSportunity: ?{|
    +clientMutationId: ?string,
    +edge: ?{|
      +node: ?{|
  ...
  |}
|};
export type RefuseInvitationMutation = {|
  variables: RefuseInvitationMutationVariables,
  response: RefuseInvitationMutationResponse,
|};
*/


/*
mutation RefuseInvitationMutation(
  $input: updateSportunityInput!
) {
...
return {
  ...
  "name": "RefuseInvitationMutation",
  "id": null,
  "text": "mutation RefuseInvitationMutation(\n  $input: updateSportunityInput!\n) {\n  updateSportunity(input: $input) {\n    clientMutationId\n    edge {\n      node {\n        id\n        status\n        participants {\n          id\n          pseudo\n          avatar\n        }\n        waiting {\n          id\n          pseudo\n          avatar\n        }\n        willing {\n          id\n          pseudo\n          avatar\n        }\n        canceling {\n          canceling_user {\n            id\n            pseudo\n            avatar\n          }\n          status\n          cancelation_date\n        }\n        invited {\n          user {\n            id\n            pseudo\n            avatar\n          }\n          answer\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "RefuseInvitationMutation",
...
// prettier-ignore
(node/*: any*/).hash = 'd75836f54d26ba42710c7ef6fbf5c41a';
module.exports = node;
