/**
 * @flow
 * @relayHash c7e1109cdf458397e7c7dcd00a6fbce9
 */
...
export type EventDetailCarpoolingContainerQueryVariables = {|
  sportunityId?: ?string,
  sportunityChatId?: ?string,
  sportunityRelaunchId: string,
  query: boolean,
|};
export type EventDetailCarpoolingContainerQueryResponse = {|
  +$fragmentRefs: EventDetailCarpoolingContainer_query$ref
|};
export type EventDetailCarpoolingContainerQuery = {|
  variables: EventDetailCarpoolingContainerQueryVariables,
  response: EventDetailCarpoolingContainerQueryResponse,
|};
*/


/*
query EventDetailCarpoolingContainerQuery(
  $sportunityId: ID
  $query: Boolean!
) {
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "EventDetailCarpoolingContainerQuery",
  "id": null,
  "text": "query EventDetailCarpoolingContainerQuery(\n  $sportunityId: ID\n  $query: Boolean!\n) {\n  ...EventDetailCarpoolingContainer_query_4tXwtP\n}\n\nfragment EventDetailCarpoolingContainer_query_4tXwtP on Query {\n  viewer {\n    id\n    ...EventDetailCarpooling_viewer\n    me @include(if: $query) {\n      ...EventDetailCarpooling_user\n      id\n    }\n  sportunity(id: $sportunityId) @include(if: $query) {\n      ...EventDetailCarpooling_sportunity\n      id\n    }\n  }\n}\n\nfragment EventDetailCarpooling_viewer on Viewer {\n  ...Carpooling_viewer\n}\n\nfragment EventDetailCarpooling_user on User {\n  id\n  avatar\n  pseudo\n  profileType\n}\n\nfragment EventDetailCarpooling_sportunity on Sportunity {\n  ...Carpooling_sportunity\n  id\n  carPoolings {\n    id\n    driver {\n      id\n      pseudo\n      avatar\n    }\n    address {\n      address\n      city\n      zip\n      country\n    }\n    starting_date\n    number_of_sits\n    passengers {\n      id\n      pseudo\n      avatar\n    }\n  }\n  address {\n    address\n    country\n    city\n    zip\n    position {\n      lat\n      lng\n    }\n    ...DetailCellItem_address\n  }\n  participants {\n    id\n    pseudo\n    avatar\n  }\n  organizers {\n    isAdmin\n    secondaryOrganizerType {\n      id\n      name {\n        FR\n        EN\n        DE\n        ES\n        id\n      }\n    }\n    customSecondaryOrganizerType\n    price {\n      cents\n      currency\n    }\n    organizer {\n      id\n      pseudo\n      sportunityNumber\n      feedbacks {\n        averageRating\n        count\n      }\n      sports {\n        levels {\n          EN {\n            name\n          }\n          id\n        }\n      }\n      address {\n        address\n        country\n        city\n        zip\n        position {\n          lat\n          lng\n        }\n      }\n      avatar\n      followers {\n        id\n      }\n    }\n    permissions {\n      detailsAccess {\n        view\n        edit\n      }\n      chatAccess {\n        view\n        edit\n      }\n      memberAccess {\n        view\n        edit\n      }\n      carPoolingAccess {\n        view\n        edit\n      }\n      imageAccess {\n        view\n        edit\n      }\n      compositionAccess {\n        view\n        edit\n      }\n    }\n    ...ButtonFeedback_organizers\n    id\n  }\n}\n\nfragment Carpooling_sportunity on Sportunity {\n  id\n  beginning_date\n  carPoolings {\n    id\n    driver {\n      id\n      pseudo\n      avatar\n    }\n    address {\n      address\n      city\n      zip\n      country\n    }\n    starting_date\n    number_of_sits\n    passengers {\n      id\n      pseudo\n      avatar\n    }\n  }\n}\n\nfragment DetailCellItem_address on AddressModel {\n  address\n  city\n  country\n  position {\n    lat\n    lng\n  }\n}\n\nfragment ButtonFeedback_organizers on Organizer {\n  isAdmin\n  organizer {\n    id\n    pseudo\n    feedbacks {\n      feedbacksList(last: 1000) {\n        edges {\n          node {\n            author {\n              id\n            }\n            id\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment Carpooling_viewer on Viewer {\n  id\n  me {\n    id\n    address {\n      country\n      city\n      address\n      zip\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "EventDetailCarpoolingContainerQuery",
...
// prettier-ignore
(node/*: any*/).hash = '7a22144d33eca7b71921945e52d78941';
module.exports = node;
