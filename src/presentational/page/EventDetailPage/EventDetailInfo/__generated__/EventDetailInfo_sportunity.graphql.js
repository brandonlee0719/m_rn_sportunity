...
type EventStatistics_sportunity$ref = any;
...
declare export opaque type EventDetailInfo_sportunity$ref: FragmentReference;
export type EventDetailInfo_sportunity = {|
  +id: string,
  +title: string,
  +description: string,
  +status: ?string,
  ...
  +game_information: ?{|
    ...
    |}
  |},
  +$fragmentRefs: Header_sportunity$ref & StatusView_sportunity$ref & DescriptionView_sportunity$ref & DateSportunity_sportunity$ref & AdvancedSettingsView_sportunity$ref & PriceView_sportunity$ref & StatisticFillingModal_sportunity$ref & EventStatistics_sportunity$ref & SurveyView_sportunity$ref & SurveyModal_sportunity$ref & Compositions_sportunity$ref & ButtonSportunity_sportunity$ref & VoteForManOfTheGame_sportunity$ref & TopContent_sportunity$ref,
  +$refType: EventDetailInfo_sportunity$ref,
|};
*/
...
// prettier-ignore
(node/*: any*/).hash = '7f2cab8eced4557375921531f6685b6e';
module.exports = node;
