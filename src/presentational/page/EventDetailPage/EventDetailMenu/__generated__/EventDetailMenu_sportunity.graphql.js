...
declare export opaque type EventDetailMenu_sportunity$ref: FragmentReference;
export type EventDetailMenu_sportunity = {|
  +id: string,
  +title: string,
  +description: string,
  +status: ?string,
  ...
  +$refType: EventDetailMenu_sportunity$ref,
|};
*/
...
// prettier-ignore
(node/*: any*/).hash = '8cbd95a24f1d5404f7cb8f034beccc65';
module.exports = node;
