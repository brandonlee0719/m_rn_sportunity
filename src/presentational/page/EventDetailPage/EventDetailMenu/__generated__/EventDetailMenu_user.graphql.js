...
declare export opaque type EventDetailMenu_user$ref: FragmentReference;
export type EventDetailMenu_user = {|
  +id: string,
  +avatar: ?string,
  +pseudo: string,
  ...
  +$refType: EventDetailMenu_user$ref,
|};
*/
...
// prettier-ignore
(node/*: any*/).hash = '2a01885505cc605140ff18e668a64510';
module.exports = node;
