...
declare export opaque type EventDetailMembers_sportunity$ref: FragmentReference;
export type EventDetailMembers_sportunity = {|
  +id: string,
  +title: string,
  +description: string,
  +status: ?string,
  ...
  +game_information: ?{|
    ...
    |}
  |},
  +$fragmentRefs: Header_sportunity$ref & StatusView_sportunity$ref & DescriptionView_sportunity$ref & DateSportunity_sportunity$ref & AdvancedSettingsView_sportunity$ref & PriceView_sportunity$ref & StatisticFillingModal_sportunity$ref & SurveyView_sportunity$ref & SurveyModal_sportunity$ref & Compositions_sportunity$ref & ButtonSportunity_sportunity$ref & VoteForManOfTheGame_sportunity$ref,
  +$refType: EventDetailMembers_sportunity$ref,
|};
*/
...
// prettier-ignore
(node/*: any*/).hash = '2310790d1a335639fdab7c682ae17d8e';
module.exports = node;
