/**
 * @flow
 * @relayHash 8939761c43d3121ba5d65f91a7beb144
 */
...
export type UpdateSportunityCalendarMutationVariables = {|
  input: upUserInput
|};
export type UpdateSportunityCalendarMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +user: ?{|
      +id: string,
  ...
  |}
|};
export type UpdateSportunityCalendarMutation = {|
  variables: UpdateSportunityCalendarMutationVariables,
  response: UpdateSportunityCalendarMutationResponse,
|};
*/


/*
mutation UpdateSportunityCalendarMutation(
  $input: upUserInput!
) {
  upUser(input: $input) {
    clientMutationId
...
return {
  ...
  "name": "UpdateSportunityCalendarMutation",
  "id": null,
  "text": "mutation UpdateSportunityCalendarMutation(\n  $input: upUserInput!\n) {\n  upUser(input: $input) {\n    clientMutationId\n    user {\n      id\n      calendar {\n        users {\n          id\n        }\n        sportunities(last: 1000) {\n          edges {\n            node {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "UpdateSportunityCalendarMutation",
...
// prettier-ignore
(node/*: any*/).hash = 'd556871475e406087ecd5060d5f381f7';
module.exports = node;
