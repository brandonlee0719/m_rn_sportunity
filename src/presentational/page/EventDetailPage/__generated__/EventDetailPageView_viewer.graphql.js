...
declare export opaque type EventDetailPageView_viewer$ref: FragmentReference;
export type EventDetailPageView_viewer = {|
  +relaunchInviteds?: ?{|
    +id: string
  |},
  +authorizedAccounts?: ?{|
  ...
  +superMe?: ?{|
    ...
    |}>,
  |},
  +$fragmentRefs: VoteForManOfTheGame_viewer$ref & PriceView_viewer$ref & ButtonSportunity_viewer$ref & Carpooling_viewer$ref & ParticipantsList_viewer$ref & ButtonFeedback_viewer$ref & StatisticFillingModal_viewer$ref,
  +$refType: EventDetailPageView_viewer$ref,
|};
*/
...
// prettier-ignore
(node/*: any*/).hash = '7f965b1bd43cea0256a240ebd69d9a65';
module.exports = node;
