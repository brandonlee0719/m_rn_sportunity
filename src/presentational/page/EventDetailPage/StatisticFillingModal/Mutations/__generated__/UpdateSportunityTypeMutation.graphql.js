/**
 * @flow
 * @relayHash c158fca40a5ac85cfa92b62dbcae63e7
 */
...
export type UpdateSportunityTypeMutationVariables = {|
  input: updateSportunityInput
|};
export type UpdateSportunityTypeMutationResponse = {|
  +updateSportunity: ?{|
    +clientMutationId: ?string,
    +edge: ?{|
      +node: ?{|
  ...
  |}
|};
export type UpdateSportunityTypeMutation = {|
  variables: UpdateSportunityTypeMutationVariables,
  response: UpdateSportunityTypeMutationResponse,
|};
*/


/*
mutation UpdateSportunityTypeMutation(
  $input: updateSportunityInput!
) {
...
return {
  ...
  "name": "UpdateSportunityTypeMutation",
  "id": null,
  "text": "mutation UpdateSportunityTypeMutation(\n  $input: updateSportunityInput!\n) {\n  updateSportunity(input: $input) {\n    clientMutationId\n    edge {\n      node {\n        id\n        sportunityType {\n          id\n          name {\n            FR\n            EN\n            id\n          }\n          statuses {\n            id\n            name {\n              FR\n              EN\n              id\n            }\n          }\n          isScoreRelevant\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "UpdateSportunityTypeMutation",
...
// prettier-ignore
(node/*: any*/).hash = '649a2aeb5c97aeb97f29a06591c0391f';
module.exports = node;
