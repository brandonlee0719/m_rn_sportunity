...
declare export opaque type ChatSportunity_viewer$ref: FragmentReference;
export type ChatSportunity_viewer = {|
  +chats?: ?{|
    +edges: ?$ReadOnlyArray<?{|
      +node: ?{|
        +id: string,
  ...
  +$refType: ChatSportunity_viewer$ref,
|};
*/
...
// prettier-ignore
(node/*: any*/).hash = '699dc60140d2fe63d76aabb6df919487';
module.exports = node;
