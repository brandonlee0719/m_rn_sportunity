/**
 * @flow
 * @relayHash 6d6568766b3fd107d6095cf00b6f9b90
 */
...
export type OtherProfilePageQueryVariables = {|
  count?: ?number,
  userId: string,
...
|};
export type OtherProfilePageQueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: OtherProfilePage_viewer$ref
  |}
|};
export type OtherProfilePageQuery = {|
  variables: OtherProfilePageQueryVariables,
  response: OtherProfilePageQueryResponse,
|};
*/
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "OtherProfilePageQuery",
  "id": null,
  "text": "query OtherProfilePageQuery(\n  $count: Int\n  $userId: String!\n  $querySportunities: Boolean!\n  $queryStats: Boolean!\n  $sportunityFilter: Filter\n) {\n  viewer {\n    ...OtherProfilePage_viewer_2enCln\n    id\n  }\n}\n\nfragment OtherProfilePage_viewer_2enCln on Viewer {\n  id\n  ...SportunityListView_viewer\n  ...StatisticsTab_viewer\n  me {\n    id\n    blackList {\n      id\n    }\n    calendar {\n      users {\n        id\n      }\n      sportunities(last: 1000) {\n        edges {\n          node {\n            id\n          }\n        }\n      }\n    }\n  }\n  sportunities(first: $count, filter: $sportunityFilter, userId: $userId) @include(if: $querySportunities) {\n    ...SportunityListView_sportunities\n  }\n  user(id: $userId) {\n    ...StatisticsTab_user_2e1WFo\n    ...SportunityListView_user\n    id\n    pseudo\n    avatar\n    description\n    profileType\n    birthday\n    sex\n    blackList {\n      id\n    }\n    publicAddress {\n      city\n      country\n    }\n    reporters {\n      ...Report_reporters\n      id\n    }\n    sportunityNumber\n    languages {\n      ...Languages_languages\n      id\n    }\n    sports {\n      ...SportsList_sports\n    }\n    feedbacks {\n      ...FeedbacksList_feedbacks\n    }\n    followers {\n      id\n    }\n  }\n}\n\nfragment SportunityListView_viewer on Viewer {\n  id\n  ...SportunityItem_viewer\n}\n\nfragment StatisticsTab_viewer on Viewer {\n  ...OrganizerStatistics_viewer\n  ...ParticipantStatistics_viewer\n}\n\nfragment SportunityListView_sportunities on SportunityConnection {\n  count\n  edges {\n    node {\n      id\n      status\n      price {\n        cents\n        currency\n      }\n      invited {\n        user {\n          id\n        }\n      }\n      paymentStatus {\n        user {\n          id\n        }\n        status\n        price {\n          cents\n          currency\n        }\n        id\n      }\n      survey {\n        isSurveyTransformed\n        surveyDates {\n          answers {\n            user {\n              id\n            }\n          }\n        }\n      }\n      game_information {\n        opponent {\n          lookingForAnOpponent\n          invitedOpponents(last: 5) {\n            edges {\n              node {\n                id\n                members {\n                  id\n                }\n              }\n            }\n          }\n        }\n      }\n      organizers {\n        organizer {\n          id\n          pseudo\n        }\n        isAdmin\n        role\n        price {\n          currency\n          cents\n        }\n        secondaryOrganizerType {\n          id\n          name {\n            id\n            EN\n            FR\n          }\n        }\n        customSecondaryOrganizerType\n        permissions {\n          chatAccess {\n            view\n            edit\n          }\n          memberAccess {\n            view\n            edit\n          }\n          carPoolingAccess {\n            view\n            edit\n          }\n          imageAccess {\n            view\n            edit\n          }\n          detailsAccess {\n            view\n            edit\n          }\n          compositionAccess {\n            view\n            edit\n          }\n        }\n        id\n      }\n      ...SportunityItem_sportunity\n    }\n  }\n}\n\nfragment StatisticsTab_user_2e1WFo on User {\n  ...OrganizerStatistics_user\n  ...ParticipantStatistics_user\n  id\n  pseudo\n  userStatistics @include(if: $queryStats) {\n    hasData\n    percentageOfOrganized\n    globalNote\n    averageTime {\n      FR\n      EN\n      id\n    }\n    steps {\n      step {\n        FR\n        EN\n        id\n      }\n      value\n    }\n    membersUserParticipatesWith {\n      user {\n        id\n        pseudo\n        avatar\n      }\n      number\n    }\n    numberOfParticipated\n    averageNumberOfParticipatedWeek\n    averageNumberOfParticipatedMonth\n    averageNumberOfParticipatedYear\n  }\n}\n\nfragment SportunityListView_user on User {\n  id\n  profileType\n  description\n  ...SportunityItem_user\n}\n\nfragment Report_reporters on ReporterUser {\n  id\n}\n\nfragment Languages_languages on Language {\n  id\n  code\n  name\n}\n\nfragment SportsList_sports on SportDescriptor {\n  sport {\n    id\n    name {\n      id\n      EN\n      FR\n    }\n    logo\n    positions {\n      id\n      EN\n      FR\n    }\n    certificates {\n      id\n      name {\n        id\n        EN\n        FR\n      }\n    }\n    levels {\n      id\n      EN {\n        name\n        description\n        skillLevel\n      }\n      FR {\n        name\n        description\n        skillLevel\n      }\n    }\n  }\n  positions {\n    id\n    EN\n    FR\n  }\n  certificates {\n    validation\n    certificate {\n      id\n      name {\n        id\n        EN\n        FR\n      }\n    }\n  }\n  levels {\n    id\n    EN {\n      name\n      description\n      skillLevel\n    }\n    FR {\n      name\n      description\n      skillLevel\n    }\n  }\n}\n\nfragment FeedbacksList_feedbacks on Feedbacks {\n  count\n  averageRating\n  feedbacksList(first: 10) {\n    edges {\n      node {\n        id\n        text\n        rating\n        createdAt\n        author {\n          id\n          pseudo\n          avatar\n        }\n      }\n    }\n  }\n}\n\nfragment SportunityItem_user on User {\n  ...TopContent_user\n  ...BottomContent_user\n}\n\nfragment TopContent_user on User {\n  id\n}\n\nfragment BottomContent_user on User {\n  id\n}\n\nfragment OrganizerStatistics_user on User {\n  id\n  pseudo\n  circles(first: 10) {\n    edges {\n      node {\n        id\n        name\n        memberCount\n      }\n    }\n  }\n  defaultStatisticFilter {\n    id\n    name\n    date_begin\n    date_end\n    circleList(first: 10) {\n      edges {\n        node {\n          id\n        }\n      }\n    }\n  }\n  statisticFilters {\n    id\n    name\n    date_begin\n    date_end\n    circleList(first: 10) {\n      edges {\n        node {\n          id\n          name\n        }\n      }\n    }\n  }\n}\n\nfragment ParticipantStatistics_user on User {\n  id\n  pseudo\n  circlesUserIsIn(first: 20) {\n    edges {\n      node {\n        ...CirclesItem_circle\n        id\n        name\n        memberCount\n        isCircleAccessibleFromUrl\n        owner {\n          id\n          profileType\n          pseudo\n        }\n        coOwners {\n          id\n        }\n        members {\n          id\n        }\n        memberParents {\n          id\n        }\n      }\n    }\n    count\n  }\n  userStatistics @include(if: $queryStats) {\n    hasData\n    percentageOfOrganized\n    globalNote\n    averageTime {\n      FR\n      EN\n      id\n    }\n    steps {\n      step {\n        FR\n        EN\n        id\n      }\n      value\n    }\n    membersUserParticipatesWith {\n      user {\n        id\n        pseudo\n        avatar\n      }\n      number\n    }\n    numberOfParticipated\n    averageNumberOfParticipatedWeek\n    averageNumberOfParticipatedMonth\n    averageNumberOfParticipatedYear\n  }\n}\n\nfragment CirclesItem_circle on Circle {\n  id\n  name\n  memberCount\n  mode\n  isCircleUsableByMembers\n  isCircleAccessibleFromUrl\n  type\n  owner {\n    id\n    avatar\n    pseudo\n  }\n  coOwners {\n    id\n  }\n  members {\n    id\n  }\n  memberParents {\n    id\n  }\n}\n\nfragment SportunityItem_sportunity on Sportunity {\n  id\n  title\n  status\n  cancel_date\n  game_information {\n    opponent {\n      organizerPseudo\n      unknownOpponent\n      lookingForAnOpponent\n      organizer {\n        id\n        pseudo\n        avatar\n      }\n      invitedOpponents(last: 5) {\n        edges {\n          node {\n            id\n            members {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n  organizers {\n    organizer {\n      id\n      pseudo\n      avatar\n    }\n    isAdmin\n    role\n    secondaryOrganizerType {\n      id\n      name {\n        FR\n        EN\n        DE\n        ES\n        id\n      }\n    }\n    customSecondaryOrganizerType\n    id\n  }\n  ...TopContent_sportunity\n  ...BottomContent_sportunity\n}\n\nfragment TopContent_sportunity on Sportunity {\n  id\n  title\n  status\n  beginning_date\n  price {\n    currency\n    cents\n  }\n  survey {\n    isSurveyTransformed\n    surveyDates {\n      beginning_date\n      ending_date\n    }\n  }\n  organizers {\n    organizer {\n      id\n      pseudo\n      avatar\n      areStatisticsActivated\n      statisticPreferences {\n        private\n      }\n    }\n    isAdmin\n    id\n  }\n  paymentStatus {\n    user {\n      id\n    }\n    status\n    price {\n      cents\n      currency\n    }\n    id\n  }\n  venue {\n    id\n    name\n  }\n  infrastructure {\n    id\n    name\n  }\n  address {\n    address\n    country\n    city\n    zip\n    position {\n      lat\n      lng\n    }\n  }\n  participantRange {\n    from\n    to\n  }\n  sportunityType {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n  }\n  sportunityTypeStatus {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n  }\n  score {\n    currentTeam\n    adversaryTeam\n  }\n  sport {\n    sport {\n      logo\n      id\n    }\n    allLevelSelected\n    levels {\n      id\n      EN {\n        name\n        skillLevel\n      }\n      FR {\n        name\n        skillLevel\n      }\n    }\n  }\n}\n\nfragment BottomContent_sportunity on Sportunity {\n  nbShares\n  status\n  survey {\n    isSurveyTransformed\n    surveyDates {\n      answers {\n        user {\n          id\n          pseudo\n        }\n        answer\n      }\n    }\n  }\n  participants {\n    id\n  }\n  waiting {\n    id\n  }\n  willing {\n    id\n  }\n  canceling {\n    canceling_user {\n      id\n    }\n    status\n    cancelation_date\n  }\n  participantRange {\n    from\n    to\n  }\n  organizers {\n    isAdmin\n    organizer {\n      id\n      pseudo\n      avatar\n    }\n    id\n  }\n  game_information {\n    opponent {\n      organizerPseudo\n      unknownOpponent\n      lookingForAnOpponent\n      organizer {\n        id\n        pseudo\n        avatar\n      }\n      invitedOpponents(last: 5) {\n        edges {\n          node {\n            id\n            members {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment OrganizerStatistics_viewer on Viewer {\n  id\n  me {\n    id\n  }\n}\n\nfragment ParticipantStatistics_viewer on Viewer {\n  id\n  me {\n    id\n  }\n}\n\nfragment SportunityItem_viewer on Viewer {\n  ...TopContent_viewer\n}\n\nfragment TopContent_viewer on Viewer {\n  id\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "OtherProfilePageQuery",
...
// prettier-ignore
(node/*: any*/).hash = 'dc7ba27e864a6d951981d0992bed3d78';
module.exports = node;
