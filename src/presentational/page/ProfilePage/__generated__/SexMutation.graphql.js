/**
 * @flow
 * @relayHash bfe6d13d20ca6990cc3fc28faff52ea2
 */
...
export type SexMutationVariables = {|
  input: upUserInput
|};
export type SexMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +user: ?{|
      +id: string,
  ...
  |}
|};
export type SexMutation = {|
  variables: SexMutationVariables,
  response: SexMutationResponse,
|};
*/
...
// prettier-ignore
(node/*: any*/).hash = '95a3f8ea62c0917816777c1724a2b3db';
module.exports = node;
