/**
 * @flow
 * @relayHash de6e3ba6e275ef2b7358f50fc882a36c
 */
...
export type PseudoMutationVariables = {|
  input: upUserInput
|};
export type PseudoMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +user: ?{|
      +id: string,
  ...
  |}
|};
export type PseudoMutation = {|
  variables: PseudoMutationVariables,
  response: PseudoMutationResponse,
|};
*/


/*
mutation PseudoMutation(
  $input: upUserInput!
) {
  upUser(input: $input) {
    clientMutationId
...
// prettier-ignore
(node/*: any*/).hash = 'bf13b70e0bd24432c39a81842573e5d1';
module.exports = node;
