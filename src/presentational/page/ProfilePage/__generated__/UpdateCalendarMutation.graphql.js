/**
 * @flow
 * @relayHash 281f90a0e09f75c93df9c4d0eac1d90c
 */
...
export type UpdateCalendarMutationVariables = {|
  input: upUserInput
|};
export type UpdateCalendarMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +user: ?{|
      +id: string,
...
export type UpdateCalendarMutation = {|
  variables: UpdateCalendarMutationVariables,
  response: UpdateCalendarMutationResponse,
|};
*/
...
return {
  ...
  "name": "UpdateCalendarMutation",
  "id": null,
  "text": "mutation UpdateCalendarMutation(\n  $input: upUserInput!\n) {\n  upUser(input: $input) {\n    clientMutationId\n    user {\n      id\n      calendar {\n        users {\n          id\n        }\n        sportunities(last: 1000) {\n          edges {\n            node {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "UpdateCalendarMutation",
...
// prettier-ignore
(node/*: any*/).hash = '4fb995a76681ef3afb75b727da4cd2c9';
module.exports = node;
