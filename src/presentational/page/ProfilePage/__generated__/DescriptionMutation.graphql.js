/**
 * @flow
 * @relayHash df5efa5a7d8116c5fdbb571ec81637a1
 */
...
export type DescriptionMutationVariables = {|
  input: upUserInput
|};
export type DescriptionMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +user: ?{|
      +id: string,
...
export type DescriptionMutation = {|
  ...
  response: DescriptionMutationResponse,
|};
*/
...
// prettier-ignore
(node/*: any*/).hash = '1e0289093e5e10dccea8f9065f6bbab4';
module.exports = node;
