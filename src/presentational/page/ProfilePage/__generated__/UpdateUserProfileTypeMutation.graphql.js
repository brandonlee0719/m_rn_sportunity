/**
 * @flow
 * @relayHash d30962562437415dd34d9e5abc70535a
 */
...
export type UpdateUserProfileTypeMutationVariables = {|
  input: upUserInput
|};
export type UpdateUserProfileTypeMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +user: ?{|
      +id: string,
  ...
  |}
|};
export type UpdateUserProfileTypeMutation = {|
  variables: UpdateUserProfileTypeMutationVariables,
  response: UpdateUserProfileTypeMutationResponse,
|};
*/


/*
mutation UpdateUserProfileTypeMutation(
  $input: upUserInput!
) {
  upUser(input: $input) {
    clientMutationId
...
return {
  ...
  "name": "UpdateUserProfileTypeMutation",
  "id": null,
  "text": "mutation UpdateUserProfileTypeMutation(\n  $input: upUserInput!\n) {\n  upUser(input: $input) {\n    clientMutationId\n    user {\n      id\n      profileType\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "UpdateUserProfileTypeMutation",
...
// prettier-ignore
(node/*: any*/).hash = '59c4ca39c408ff4b4c70a8e502368552';
module.exports = node;
