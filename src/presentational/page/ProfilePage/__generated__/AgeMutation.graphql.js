/**
 * @flow
 * @relayHash 21866517420322ba28d9d1201ff5006a
 */
...
export type AgeMutationVariables = {|
  input: upUserInput
|};
export type AgeMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +user: ?{|
      +id: string,
  ...
  |}
|};
export type AgeMutation = {|
  variables: AgeMutationVariables,
  response: AgeMutationResponse,
|};
*/
...
// prettier-ignore
(node/*: any*/).hash = '7a7212946ece418d10ec2ead9c21dcb4';
module.exports = node;
