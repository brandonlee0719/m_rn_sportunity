/**
 * @flow
 * @relayHash 1f5c2a18c42aad6f719f7975f3ded05a
 */
...
export type ConfirmBookingPageRefetchQueryVariables = {|
  id?: ?string
|};
export type ConfirmBookingPageRefetchQueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: ConfirmBookingPage_viewer$ref
  |}
|};
export type ConfirmBookingPageRefetchQuery = {|
  variables: ConfirmBookingPageRefetchQueryVariables,
  response: ConfirmBookingPageRefetchQueryResponse,
|};
*/


/*
query ConfirmBookingPageRefetchQuery(
  $id: ID
) {
  viewer {
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "ConfirmBookingPageRefetchQuery",
  "id": null,
  "text": "query ConfirmBookingPageRefetchQuery(\n  $id: ID\n) {\n  viewer {\n    ...ConfirmBookingPage_viewer_1Bmzm5\n    id\n  }\n}\n\nfragment ConfirmBookingPage_viewer_1Bmzm5 on Viewer {\n  id\n  ...ButtonSportunity_viewer\n  ...PriceView_viewer\n  me {\n    id\n    firstName\n    lastName\n    address {\n      country\n    }\n    paymentMethods {\n      id\n      cardType\n      cardMask\n      expirationDate\n    }\n    ...ButtonSportunity_user\n  }\n  sportunity(id: $id) {\n    id\n    price {\n      cents\n      currency\n    }\n    status\n    ...ConfirmBookingPageHeader_sportunity\n    ...ButtonSportunity_sportunity\n    ...PriceView_sportunity\n  }\n}\n\nfragment ButtonSportunity_viewer on Viewer {\n  id\n  me {\n    id\n    isProfileComplete\n    paymentMethods {\n      id\n      cardType\n      cardMask\n      expirationDate\n    }\n  }\n}\n\nfragment PriceView_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment ButtonSportunity_user on User {\n  id\n}\n\nfragment ConfirmBookingPageHeader_sportunity on Sportunity {\n  title\n  ...DateSportunity_sportunity\n  sport_con: sport {\n    sport {\n      logo\n      id\n    }\n  }\n}\n\nfragment ButtonSportunity_sportunity on Sportunity {\n  id\n  status\n  waiting {\n    id\n  }\n  cancel_date\n  canceling {\n    canceling_user {\n      id\n    }\n    status\n    cancelation_date\n  }\n  price {\n    cents\n    currency\n  }\n  organizers {\n    organizer {\n      pseudo\n      id\n    }\n    isAdmin\n    id\n  }\n  participants {\n    id\n    pseudo\n    avatar\n  }\n}\n\nfragment PriceView_sportunity on Sportunity {\n  kind\n  price {\n    currency\n    cents\n  }\n  paymentStatus {\n    user {\n      id\n    }\n    status\n    price {\n      cents\n      currency\n    }\n    id\n  }\n  invited_circles(last: 100) {\n    edges {\n      node {\n        id\n        name\n        mode\n        memberCount\n        type\n        owner {\n          id\n          avatar\n          pseudo\n        }\n        members {\n          id\n          pseudo\n        }\n      }\n    }\n  }\n  price_for_circle {\n    circle {\n      id\n    }\n    price {\n      cents\n      currency\n    }\n  }\n}\n\nfragment DateSportunity_sportunity on Sportunity {\n  beginning_date\n  ending_date\n  sport {\n    sport {\n      logo\n      id\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "ConfirmBookingPageRefetchQuery",
...
// prettier-ignore
(node/*: any*/).hash = '3580ae99ad0f4345d405ffc4da8fb79a';
module.exports = node;
