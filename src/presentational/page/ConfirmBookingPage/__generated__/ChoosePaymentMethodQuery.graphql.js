/**
 * @flow
 * @relayHash 45e96948ea42f2fd24bb6f39cbc7c6fb
 */
...
export type ChoosePaymentMethodQueryVariables = {|
  id?: ?string,
  query: boolean,
|};
export type ChoosePaymentMethodQueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: ChoosePaymentMethod_viewer$ref
  |}
|};
export type ChoosePaymentMethodQuery = {|
  variables: ChoosePaymentMethodQueryVariables,
  response: ChoosePaymentMethodQueryResponse,
|};
*/
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "ChoosePaymentMethodQuery",
  "id": null,
  "text": "query ChoosePaymentMethodQuery(\n  $id: ID\n  $query: Boolean!\n) {\n  viewer {\n    ...ChoosePaymentMethod_viewer_1QsYUi\n    id\n  }\n}\n\nfragment ChoosePaymentMethod_viewer_1QsYUi on Viewer {\n  id\n  ...PriceView_viewer\n  me {\n    id\n    firstName\n    lastName\n    address {\n      country\n    }\n    paymentMethods {\n      id\n      cardType\n      cardMask\n      expirationDate\n      ...PaymentMethodsList_paymentMethods\n    }\n  }\n  sportunity(id: $id) {\n    ...ConfirmBookingPageHeader_sportunity\n    id\n    price {\n      cents\n      currency\n    }\n    paymentStatus {\n      user {\n        id\n      }\n      status\n      price {\n        cents\n        currency\n      }\n      id\n    }\n    ...Header_sportunity\n    ...PriceView_sportunity\n  }\n  amountOnWallet @include(if: $query) {\n    amountOnWallet {\n      cents\n      currency\n    }\n    lockedAmount {\n      cents\n      currency\n    }\n  }\n}\n\nfragment PriceView_viewer on Viewer {\n  me {\n    id\n  }\n}\n\nfragment PaymentMethodsList_paymentMethods on PaymentMethod {\n  id\n  cardType\n  cardMask\n  expirationDate\n}\n\nfragment ConfirmBookingPageHeader_sportunity on Sportunity {\n  title\n  ...DateSportunity_sportunity\n  sport_con: sport {\n    sport {\n      logo\n      id\n    }\n  }\n}\n\nfragment Header_sportunity on Sportunity {\n  id\n  kind\n  title\n  beginning_date\n  ending_date\n  images\n  sport {\n    allLevelSelected\n    sport {\n      name {\n        EN\n        FR\n        id\n      }\n      logo\n      id\n    }\n    ...levels_sport\n  }\n  participants {\n    id\n    pseudo\n  }\n  participantRange {\n    from\n    to\n  }\n}\n\nfragment PriceView_sportunity on Sportunity {\n  kind\n  price {\n    currency\n    cents\n  }\n  paymentStatus {\n    user {\n      id\n    }\n    status\n    price {\n      cents\n      currency\n    }\n    id\n  }\n  invited_circles(last: 100) {\n    edges {\n      node {\n        id\n        name\n        mode\n        memberCount\n        type\n        owner {\n          id\n          avatar\n          pseudo\n        }\n        members {\n          id\n          pseudo\n        }\n      }\n    }\n  }\n  price_for_circle {\n    circle {\n      id\n    }\n    price {\n      cents\n      currency\n    }\n  }\n}\n\nfragment levels_sport on SportunitySport {\n  allLevelSelected\n  levels {\n    id\n    EN {\n      name\n      description\n      skillLevel\n    }\n    FR {\n      name\n      description\n      skillLevel\n    }\n  }\n}\n\nfragment DateSportunity_sportunity on Sportunity {\n  beginning_date\n  ending_date\n  sport {\n    sport {\n      logo\n      id\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "ChoosePaymentMethodQuery",
...
// prettier-ignore
(node/*: any*/).hash = '61b77fc13352723f69bb408edf93fa27';
module.exports = node;
