/**
 * @flow
 * @relayHash 66669ecbcf1e3a43a975e5db97815736
 */
...
export type SearchModuleRefetchQueryVariables = {|
  queryMain: boolean,
  queryUsers: boolean,
  text?: ?string,
  firstUsers?: ?number,
  ...
  superToken?: ?string,
|};
export type SearchModuleRefetchQueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: SearchModule_viewer$ref
  |}
|};
export type SearchModuleRefetchQuery = {|
  variables: SearchModuleRefetchQueryVariables,
  response: SearchModuleRefetchQueryResponse,
|};
*/
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "SearchModuleRefetchQuery",
  "id": null,
  "text": "query SearchModuleRefetchQuery(\n  $queryMain: Boolean!\n  $queryUsers: Boolean!\n  $text: String\n  $firstUsers: Int\n  $userType: UserProfileType\n  $queryCircles: Boolean!\n  $circlesFilter: CirclesFilter\n  $firstCircles: Int\n  $querySportunities: Boolean!\n  $sportunityFilter: Filter\n  $firstSportunities: Int\n  $circleId: ID\n  $queryOpponents: Boolean!\n  $sportId: String\n  $superToken: String\n) {\n  viewer {\n    ...SearchModule_viewer_3piPK0\n    id\n  }\n}\n\nfragment SearchModule_viewer_3piPK0 on Viewer {\n  id\n  ...SportunityItem_viewer\n  ...FilterDetailSports_viewer\n  me {\n    id\n    profileType\n    ...SportunityItem_user\n  }\n  superMe(superToken: $superToken) @include(if: $queryMain) {\n    id\n    subAccounts {\n      id\n    }\n  }\n  circles(filter: $circlesFilter, first: $firstCircles) @include(if: $queryMain) {\n    count\n    edges @include(if: $queryCircles) {\n      node {\n        ...CirclesItem_circle\n        id\n        owner {\n          id\n          avatar\n          pseudo\n        }\n        isCircleAccessibleFromUrl\n        mode\n        type\n        coOwners {\n          id\n        }\n        members {\n          id\n          pseudo\n          avatar\n          profileType\n        }\n        memberParents {\n          id\n        }\n      }\n    }\n  }\n  users(pseudo: $text, first: $firstUsers, userType: $userType) @include(if: $queryMain) {\n    count\n    edges @include(if: $queryUsers) {\n      node {\n        id\n        profileType\n        ...UserCard_user\n      }\n    }\n  }\n  sportunities(filter: $sportunityFilter, first: $firstSportunities) @include(if: $queryMain) {\n    count\n    edges @include(if: $querySportunities) {\n      node {\n        id\n        ...SportunityItem_sportunity\n      }\n    }\n  }\n  opponents(sportId: $sportId, pseudo: $text, first: $firstUsers) @include(if: $queryMain) {\n    count\n    edges @include(if: $queryOpponents) {\n      node {\n        id\n        avatar\n        pseudo\n      }\n    }\n  }\n  selectedCircle: circle(id: $circleId) {\n    id\n    name\n    owner {\n      id\n      pseudo\n      avatar\n    }\n    members {\n      id\n      pseudo\n      avatar\n      profileType\n    }\n    memberCount\n  }\n}\n\nfragment SportunityItem_viewer on Viewer {\n  ...TopContent_viewer\n}\n\nfragment FilterDetailSports_viewer on Viewer {\n  filterSport: sport {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n    logo\n    levels {\n      id\n      EN {\n        name\n      }\n      FR {\n        name\n      }\n    }\n  }\n}\n\nfragment SportunityItem_user on User {\n  ...TopContent_user\n  ...BottomContent_user\n}\n\nfragment CirclesItem_circle on Circle {\n  id\n  name\n  memberCount\n  mode\n  isCircleUsableByMembers\n  isCircleAccessibleFromUrl\n  type\n  owner {\n    id\n    avatar\n    pseudo\n  }\n  coOwners {\n    id\n  }\n  members {\n    id\n  }\n  memberParents {\n    id\n  }\n}\n\nfragment UserCard_user on User {\n  id\n  pseudo\n  firstName\n  lastName\n  avatar\n  circlesUserIsIn(first: 3) {\n    count\n    edges {\n      node {\n        id\n        name\n      }\n    }\n  }\n  sports {\n    sport {\n      id\n      logo\n    }\n  }\n}\n\nfragment SportunityItem_sportunity on Sportunity {\n  id\n  title\n  status\n  cancel_date\n  game_information {\n    opponent {\n      organizerPseudo\n      unknownOpponent\n      lookingForAnOpponent\n      organizer {\n        id\n        pseudo\n        avatar\n      }\n      invitedOpponents(last: 5) {\n        edges {\n          node {\n            id\n            members {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n  organizers {\n    organizer {\n      id\n      pseudo\n      avatar\n    }\n    isAdmin\n    role\n    secondaryOrganizerType {\n      id\n      name {\n        FR\n        EN\n        DE\n        ES\n        id\n      }\n    }\n    customSecondaryOrganizerType\n    id\n  }\n  ...TopContent_sportunity\n  ...BottomContent_sportunity\n}\n\nfragment TopContent_sportunity on Sportunity {\n  id\n  title\n  status\n  beginning_date\n  price {\n    currency\n    cents\n  }\n  survey {\n    isSurveyTransformed\n    surveyDates {\n      beginning_date\n      ending_date\n    }\n  }\n  organizers {\n    organizer {\n      id\n      pseudo\n      avatar\n      areStatisticsActivated\n      statisticPreferences {\n        private\n      }\n    }\n    isAdmin\n    id\n  }\n  paymentStatus {\n    user {\n      id\n    }\n    status\n    price {\n      cents\n      currency\n    }\n    id\n  }\n  venue {\n    id\n    name\n  }\n  infrastructure {\n    id\n    name\n  }\n  address {\n    address\n    country\n    city\n    zip\n    position {\n      lat\n      lng\n    }\n  }\n  participantRange {\n    from\n    to\n  }\n  sportunityType {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n  }\n  sportunityTypeStatus {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n  }\n  score {\n    currentTeam\n    adversaryTeam\n  }\n  sport {\n    sport {\n      logo\n      id\n    }\n    allLevelSelected\n    levels {\n      id\n      EN {\n        name\n        skillLevel\n      }\n      FR {\n        name\n        skillLevel\n      }\n    }\n  }\n}\n\nfragment BottomContent_sportunity on Sportunity {\n  nbShares\n  status\n  survey {\n    isSurveyTransformed\n    surveyDates {\n      answers {\n        user {\n          id\n          pseudo\n        }\n        answer\n      }\n    }\n  }\n  participants {\n    id\n  }\n  waiting {\n    id\n  }\n  willing {\n    id\n  }\n  canceling {\n    canceling_user {\n      id\n    }\n    status\n    cancelation_date\n  }\n  participantRange {\n    from\n    to\n  }\n  organizers {\n    isAdmin\n    organizer {\n      id\n      pseudo\n      avatar\n    }\n    id\n  }\n  game_information {\n    opponent {\n      organizerPseudo\n      unknownOpponent\n      lookingForAnOpponent\n      organizer {\n        id\n        pseudo\n        avatar\n      }\n      invitedOpponents(last: 5) {\n        edges {\n          node {\n            id\n            members {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment TopContent_user on User {\n  id\n}\n\nfragment BottomContent_user on User {\n  id\n}\n\nfragment TopContent_viewer on Viewer {\n  id\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "SearchModuleRefetchQuery",
...
// prettier-ignore
(node/*: any*/).hash = 'f8000c345b649bae6132a0e2f84d7d26';
module.exports = node;
