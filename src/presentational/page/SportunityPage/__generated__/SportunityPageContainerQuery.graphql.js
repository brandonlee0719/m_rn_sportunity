/**
 * @flow
 * @relayHash 67c94fa114d1e0b2f0c5780dc2223ace
 */
...
export type SportunityPageContainerQueryVariables = {|
  count: number,
  filter?: ?Filter,
  orderBy?: ?Sportunities_Order,
  query: boolean,
|};
export type SportunityPageContainerQueryResponse = {|
  +$fragmentRefs: SportunityPageContainer_query$ref
|};
export type SportunityPageContainerQuery = {|
  variables: SportunityPageContainerQueryVariables,
  response: SportunityPageContainerQueryResponse,
|};
*/


/*
query SportunityPageContainerQuery(
  $count: Int!
  $filter: Filter
  $orderBy: Sportunities_Order
  $query: Boolean!
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "SportunityPageContainerQuery",
  "id": null,
  "text": "query SportunityPageContainerQuery(\n  $count: Int!\n  $filter: Filter\n  $orderBy: Sportunities_Order\n  $query: Boolean!\n) {\n  ...SportunityPageContainer_query_25j1CH\n}\n\nfragment SportunityPageContainer_query_25j1CH on Query {\n  viewer {\n    ...SportunityPage_viewer\n    sportunityTypes(sportType: COLLECTIVE) {\n      id\n      name {\n        FR\n        EN\n        id\n      }\n    }\n    sportunities(first: $count, filter: $filter, orderBy: $orderBy) @include(if: $query) {\n      count\n      ...SportunityPage_sportunities\n    }\n    me {\n      id\n      appLanguage\n      appCountry\n      appCurrency\n      avatar\n      profileType\n      publicAddress {\n        city\n        country\n        position {\n          lat\n          lng\n        }\n      }\n      subAccounts {\n        id\n        pseudo\n      }\n      basicSavedFiltersCreated\n      savedFilters {\n        id\n        page\n        filterName\n        status\n        statuses\n        users {\n          id\n          pseudo\n        }\n        subAccounts {\n          id\n          pseudo\n        }\n        circles(last: 20) {\n          edges {\n            node {\n              id\n              name\n              owner {\n                id\n                pseudo\n                avatar\n              }\n            }\n          }\n        }\n        location {\n          lat\n          lng\n          radius\n        }\n        dates {\n          from\n          to\n        }\n        price {\n          from\n          to\n        }\n        sportunityTypes {\n          id\n          name {\n            FR\n            EN\n            id\n          }\n        }\n        sport {\n          sport {\n            id\n            name {\n              EN\n              FR\n              id\n            }\n            logo\n            levels {\n              id\n              EN {\n                name\n                description\n                skillLevel\n              }\n              FR {\n                name\n                description\n                skillLevel\n              }\n            }\n          }\n          levels {\n            id\n            EN {\n              name\n              description\n              skillLevel\n            }\n            FR {\n              name\n              description\n              skillLevel\n            }\n          }\n        }\n      }\n      defaultSavedFilter {\n        id\n        filterName\n        status\n        statuses\n        page\n        circles(last: 20) {\n          edges {\n            node {\n              id\n              name\n              owner {\n                id\n                pseudo\n                avatar\n              }\n            }\n          }\n        }\n        sport {\n          sport {\n            id\n            name {\n              EN\n              FR\n              id\n            }\n            logo\n            levels {\n              id\n              EN {\n                name\n                description\n                skillLevel\n              }\n              FR {\n                name\n                description\n                skillLevel\n              }\n            }\n          }\n          levels {\n            id\n            EN {\n              name\n              description\n              skillLevel\n            }\n            FR {\n              name\n              description\n              skillLevel\n            }\n          }\n        }\n        location {\n          lat\n          lng\n          radius\n        }\n        dates {\n          from\n          to\n        }\n        price {\n          from\n          to\n        }\n      }\n      sports {\n        sport {\n          id\n        }\n      }\n    }\n    id\n  }\n}\n\nfragment SportunityPage_viewer on Viewer {\n  id\n  ...Stepper_viewer\n  me {\n    ...SportunityListView_user\n    id\n    avatar\n    profileType\n    mangoId\n    isProfileComplete\n    isPublicProfileComplete\n    savedFilters {\n      id\n      filterName\n      status\n      statuses\n      users {\n        id\n        pseudo\n      }\n      subAccounts {\n        id\n        pseudo\n      }\n      circles(last: 20) {\n        edges {\n          node {\n            id\n            name\n            owner {\n              id\n              pseudo\n              avatar\n            }\n          }\n        }\n      }\n      page\n      sport {\n        sport {\n          id\n          name {\n            EN\n            FR\n            id\n          }\n          logo\n          levels {\n            id\n            EN {\n              name\n              description\n              skillLevel\n            }\n            FR {\n              name\n              description\n              skillLevel\n            }\n          }\n        }\n        levels {\n          id\n          EN {\n            name\n            description\n            skillLevel\n          }\n          FR {\n            name\n            description\n            skillLevel\n          }\n        }\n      }\n      location {\n        lat\n        lng\n        radius\n      }\n      dates {\n        from\n        to\n      }\n      price {\n        from\n        to\n      }\n      sportunityTypes {\n        id\n        name {\n          FR\n          EN\n          id\n        }\n      }\n    }\n    defaultSavedFilter {\n      id\n      filterName\n      status\n      statuses\n      users {\n        id\n        pseudo\n      }\n      subAccounts {\n        id\n        pseudo\n      }\n      circles(last: 20) {\n        edges {\n          node {\n            id\n            name\n            owner {\n              id\n              pseudo\n              avatar\n            }\n          }\n        }\n      }\n      page\n      sport {\n        sport {\n          id\n          name {\n            EN\n            FR\n            id\n          }\n          logo\n          levels {\n            id\n            EN {\n              name\n              description\n              skillLevel\n            }\n            FR {\n              name\n              description\n              skillLevel\n            }\n          }\n        }\n        levels {\n          id\n          EN {\n            name\n            description\n            skillLevel\n          }\n          FR {\n            name\n            description\n            skillLevel\n          }\n        }\n      }\n      location {\n        lat\n        lng\n        radius\n      }\n      dates {\n        from\n        to\n      }\n      price {\n        from\n        to\n      }\n      sportunityTypes {\n        id\n        name {\n          FR\n          EN\n          id\n        }\n      }\n    }\n  }\n  ...SportunityListView_viewer\n}\n\nfragment SportunityPage_sportunities on SportunityConnection {\n  ...SportunityListView_sportunities\n  count\n  edges {\n    node {\n      id\n    }\n  }\n}\n\nfragment SportunityListView_sportunities on SportunityConnection {\n  count\n  edges {\n    node {\n      id\n      status\n      price {\n        cents\n        currency\n      }\n      invited {\n        user {\n          id\n        }\n      }\n      paymentStatus {\n        user {\n          id\n        }\n        status\n        price {\n          cents\n          currency\n        }\n        id\n      }\n      survey {\n        isSurveyTransformed\n        surveyDates {\n          answers {\n            user {\n              id\n            }\n          }\n        }\n      }\n      game_information {\n        opponent {\n          lookingForAnOpponent\n          invitedOpponents(last: 5) {\n            edges {\n              node {\n                id\n                members {\n                  id\n                }\n              }\n            }\n          }\n        }\n      }\n      organizers {\n        organizer {\n          id\n          pseudo\n        }\n        isAdmin\n        role\n        price {\n          currency\n          cents\n        }\n        secondaryOrganizerType {\n          id\n          name {\n            id\n            EN\n            FR\n          }\n        }\n        customSecondaryOrganizerType\n        permissions {\n          chatAccess {\n            view\n            edit\n          }\n          memberAccess {\n            view\n            edit\n          }\n          carPoolingAccess {\n            view\n            edit\n          }\n          imageAccess {\n            view\n            edit\n          }\n          detailsAccess {\n            view\n            edit\n          }\n          compositionAccess {\n            view\n            edit\n          }\n        }\n        id\n      }\n      ...SportunityItem_sportunity\n    }\n  }\n}\n\nfragment SportunityItem_sportunity on Sportunity {\n  id\n  title\n  status\n  cancel_date\n  game_information {\n    opponent {\n      organizerPseudo\n      unknownOpponent\n      lookingForAnOpponent\n      organizer {\n        id\n        pseudo\n        avatar\n      }\n      invitedOpponents(last: 5) {\n        edges {\n          node {\n            id\n            members {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n  organizers {\n    organizer {\n      id\n      pseudo\n      avatar\n    }\n    isAdmin\n    role\n    secondaryOrganizerType {\n      id\n      name {\n        FR\n        EN\n        DE\n        ES\n        id\n      }\n    }\n    customSecondaryOrganizerType\n    id\n  }\n  ...TopContent_sportunity\n  ...BottomContent_sportunity\n}\n\nfragment TopContent_sportunity on Sportunity {\n  id\n  title\n  status\n  beginning_date\n  price {\n    currency\n    cents\n  }\n  survey {\n    isSurveyTransformed\n    surveyDates {\n      beginning_date\n      ending_date\n    }\n  }\n  organizers {\n    organizer {\n      id\n      pseudo\n      avatar\n      areStatisticsActivated\n      statisticPreferences {\n        private\n      }\n    }\n    isAdmin\n    id\n  }\n  paymentStatus {\n    user {\n      id\n    }\n    status\n    price {\n      cents\n      currency\n    }\n    id\n  }\n  venue {\n    id\n    name\n  }\n  infrastructure {\n    id\n    name\n  }\n  address {\n    address\n    country\n    city\n    zip\n    position {\n      lat\n      lng\n    }\n  }\n  participantRange {\n    from\n    to\n  }\n  sportunityType {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n  }\n  sportunityTypeStatus {\n    id\n    name {\n      EN\n      FR\n      id\n    }\n  }\n  score {\n    currentTeam\n    adversaryTeam\n  }\n  sport {\n    sport {\n      logo\n      id\n    }\n    allLevelSelected\n    levels {\n      id\n      EN {\n        name\n        skillLevel\n      }\n      FR {\n        name\n        skillLevel\n      }\n    }\n  }\n}\n\nfragment BottomContent_sportunity on Sportunity {\n  nbShares\n  status\n  survey {\n    isSurveyTransformed\n    surveyDates {\n      answers {\n        user {\n          id\n          pseudo\n        }\n        answer\n      }\n    }\n  }\n  participants {\n    id\n  }\n  waiting {\n    id\n  }\n  willing {\n    id\n  }\n  canceling {\n    canceling_user {\n      id\n    }\n    status\n    cancelation_date\n  }\n  participantRange {\n    from\n    to\n  }\n  organizers {\n    isAdmin\n    organizer {\n      id\n      pseudo\n      avatar\n    }\n    id\n  }\n  game_information {\n    opponent {\n      organizerPseudo\n      unknownOpponent\n      lookingForAnOpponent\n      organizer {\n        id\n        pseudo\n        avatar\n      }\n      invitedOpponents(last: 5) {\n        edges {\n          node {\n            id\n            members {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment Stepper_viewer on Viewer {\n  id\n  me {\n    id\n    profileType\n    mangoId\n    pseudo\n    tutorialSteps {\n      createFormStep\n      setupMembersSubscriptionStep\n      fulfilProfileStep\n      addOfficialDocumentsStep\n      createSubAccountStep\n      shareAccessStep\n      createCircleStep\n      organizeStep\n      setupStatisticsStep\n      joinAPrivateCircleStep\n      joinAPublicCircleStep\n      giveAvailabilitiesStep\n      bookSportunityStep\n    }\n    subAccounts {\n      id\n    }\n    isSubAccount\n  }\n}\n\nfragment SportunityListView_user on User {\n  id\n  profileType\n  description\n  ...SportunityItem_user\n}\n\nfragment SportunityListView_viewer on Viewer {\n  id\n  ...SportunityItem_viewer\n}\n\nfragment SportunityItem_viewer on Viewer {\n  ...TopContent_viewer\n}\n\nfragment TopContent_viewer on Viewer {\n  id\n}\n\nfragment SportunityItem_user on User {\n  ...TopContent_user\n  ...BottomContent_user\n}\n\nfragment TopContent_user on User {\n  id\n}\n\nfragment BottomContent_user on User {\n  id\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "SportunityPageContainerQuery",
...
// prettier-ignore
(node/*: any*/).hash = '5ab63c6e25853a3545a622de5edfd8bd';
module.exports = node;
