/**
 * @flow
 * @relayHash 4d6204dbf990b4f160b2e5bbab5e2fe7
 */
...
export type UpdateCountryMutationVariables = {|
  input: upUserInput
|};
export type UpdateCountryMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +viewer: ?{|
      +me: ?{|
...
export type UpdateCountryMutation = {|
  ...
  response: UpdateCountryMutationResponse,
|};
*/
...
return {
  ...
  "name": "UpdateCountryMutation",
  "id": null,
  "text": "mutation UpdateCountryMutation(\n  $input: upUserInput!\n) {\n  upUser(input: $input) {\n    clientMutationId\n    viewer {\n      me {\n        id\n        appCountry\n        appCurrency\n      }\n      id\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "UpdateCountryMutation",
...
// prettier-ignore
(node/*: any*/).hash = '1d5a03b17cb93e744443561f6320ca6c';
module.exports = node;
