/**
 * @flow
 * @relayHash 8085cd19f770f1ea6710d32406bcd612
 */
...
export type InvitationsRefetchQueryVariables = {|
  filter?: ?CirclesFilter
|};
export type InvitationsRefetchQueryResponse = {|
  +viewer: ?{|
    +me: ?{|
  ...
  |}
|};
export type InvitationsRefetchQuery = {|
  variables: InvitationsRefetchQueryVariables,
  response: InvitationsRefetchQueryResponse,
|};
*/


/*
query InvitationsRefetchQuery(
  $filter: CirclesFilter
) {
  viewer {
    me {
      ...Invitations_user_Vt7Yj
      id
    }
    id
  }
...
fragment Invitations_user_Vt7Yj on User {
  id
  profileType
  pseudo
  email
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "InvitationsRefetchQuery",
  "id": null,
  "text": "query InvitationsRefetchQuery(\n  $filter: CirclesFilter\n) {\n  viewer {\n    me {\n      ...Invitations_user_Vt7Yj\n      id\n    }\n    id\n  }\n}\n\nfragment Invitations_user_Vt7Yj on User {\n  id\n  profileType\n  pseudo\n  email\n  circlesUserIsIn(last: 100, filter: $filter) {\n    edges {\n      cursor\n      node {\n        id\n        name\n        type\n        owner {\n          id\n          pseudo\n          avatar\n        }\n        isCircleUsableByMembers\n        memberCount\n        sport {\n          sport {\n            id\n            name {\n              FR\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n  circlesFromClub(last: 100, filter: $filter) {\n    edges {\n      cursor\n      node {\n        id\n        name\n        type\n        owner {\n          id\n          pseudo\n          avatar\n        }\n        memberCount\n        sport {\n          sport {\n            id\n            name {\n              FR\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n  circles(last: 100) {\n    edges {\n      cursor\n      node {\n        id\n        name\n        type\n        mode\n        memberCount\n        sport {\n          sport {\n            id\n            name {\n              FR\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "InvitationsRefetchQuery",
...
// prettier-ignore
(node/*: any*/).hash = 'e7d568b77f4fb5c39e61ea397453b0f4';
module.exports = node;
