/**
 * @flow
 * @relayHash fa078dc7d3770a7a93aafb4b2865d728
 */
...
export type CircleMembershipFeesPageQueryVariables = {||};
export type CircleMembershipFeesPageQueryResponse = {|
  +viewer: ?{|
    +$fragmentRefs: CircleMembershipFeesPage_viewer$ref
  |}
|};
export type CircleMembershipFeesPageQuery = {|
  variables: CircleMembershipFeesPageQueryVariables,
  response: CircleMembershipFeesPageQueryResponse,
|};
*/
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "CircleMembershipFeesPageQuery",
  "id": null,
  "text": "query CircleMembershipFeesPageQuery {\n  viewer {\n    ...CircleMembershipFeesPage_viewer\n    id\n  }\n}\n\nfragment CircleMembershipFeesPage_viewer on Viewer {\n  ...CircleUserReference_viewer\n  me {\n    id\n    circlesUserIsIn(last: 100) {\n      edges {\n        node {\n          id\n          name\n          owner {\n            id\n            pseudo\n            paymentModelFees\n            bankAccount {\n              addressLine1\n              addressLine2\n              city\n              postalCode\n              country\n              ownerName\n              IBAN\n              BIC\n              id\n            }\n          }\n          askedInformation {\n            id\n            name\n            type\n            filledByOwner\n          }\n          membersInformation {\n            id\n            information\n            user {\n              id\n            }\n            value\n          }\n          paymentModels {\n            id\n            name\n            price {\n              cents\n              currency\n            }\n            conditions {\n              id\n              name\n              price {\n                cents\n                currency\n              }\n              conditions {\n                askedInformation {\n                  id\n                  type\n                }\n                askedInformationComparator\n                askedInformationComparatorValue\n                askedInformationComparatorDate\n                askedInformationComparatorValueString\n              }\n            }\n            memberSubscriptions {\n              user {\n                id\n              }\n              amount {\n                cents\n                currency\n              }\n              beginning_date\n              ending_date\n            }\n            paymentViaBankWireAllowed\n            memberToPayFees\n            inAppPaymentAllowed\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment CircleUserReference_viewer on Viewer {\n  id\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "CircleMembershipFeesPageQuery",
...
// prettier-ignore
(node/*: any*/).hash = 'b7a29f6c51b19dc409b40076ff2d0bae';
module.exports = node;
