/**
 * @flow
 * @relayHash 2fc4bcb5cd314a05b1f33003b3fdfa6f
 */
...
export type UpdateUserCalendarMutationVariables = {|
  input: upUserInput
|};
export type UpdateUserCalendarMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +user: ?{|
      +id: string,
  ...
  |}
|};
export type UpdateUserCalendarMutation = {|
  variables: UpdateUserCalendarMutationVariables,
  response: UpdateUserCalendarMutationResponse,
|};
*/


/*
mutation UpdateUserCalendarMutation(
  $input: upUserInput!
) {
  upUser(input: $input) {
    clientMutationId
...
return {
  ...
  "name": "UpdateUserCalendarMutation",
  "id": null,
  "text": "mutation UpdateUserCalendarMutation(\n  $input: upUserInput!\n) {\n  upUser(input: $input) {\n    clientMutationId\n    user {\n      id\n      calendar {\n        users {\n          id\n          pseudo\n        }\n        preferences {\n          own_synchronized_status\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "UpdateUserCalendarMutation",
...
// prettier-ignore
(node/*: any*/).hash = '0a58171b85907b1206503d5a6356a08d';
module.exports = node;
