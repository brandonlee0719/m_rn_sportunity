/**
 * @flow
 * @relayHash 8c7545c6a3650218767a170718a5fa90
 */
...
export type UpdateUserStatMutationVariables = {|
  input: upUserInput
|};
export type UpdateUserStatMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +user: ?{|
      +id: string,
...
export type UpdateUserStatMutation = {|
  variables: UpdateUserStatMutationVariables,
  response: UpdateUserStatMutationResponse,
|};
*/


/*
mutation UpdateUserStatMutation(
  $input: upUserInput!
) {
  upUser(input: $input) {
    clientMutationId
...
return {
  ...
  "name": "UpdateUserStatMutation",
  "id": null,
  "text": "mutation UpdateUserStatMutation(\n  $input: upUserInput!\n) {\n  upUser(input: $input) {\n    clientMutationId\n    user {\n      id\n      areStatisticsActivated\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "UpdateUserStatMutation",
...
// prettier-ignore
(node/*: any*/).hash = '64e00f3af0eddfeaa98d5edfc58ab6be';
module.exports = node;
