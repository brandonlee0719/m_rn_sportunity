/**
 * @flow
 * @relayHash b9a812b482f6f57a199e7d3a1c6ecbaf
 */
...
export type UpdateUserManagersMutationVariables = {|
  input: upUserInput
|};
export type UpdateUserManagersMutationResponse = {|
  +upUser: ?{|
    +clientMutationId: ?string,
    +user: ?{|
      +id: string,
  ...
  |}
|};
export type UpdateUserManagersMutation = {|
  variables: UpdateUserManagersMutationVariables,
  response: UpdateUserManagersMutationResponse,
|};
*/


/*
mutation UpdateUserManagersMutation(
  $input: upUserInput!
) {
  upUser(input: $input) {
    clientMutationId
...
return {
  ...
  "name": "UpdateUserManagersMutation",
  "id": null,
  "text": "mutation UpdateUserManagersMutation(\n  $input: upUserInput!\n) {\n  upUser(input: $input) {\n    clientMutationId\n    user {\n      id\n      authorized_managers {\n        user {\n          id\n          pseudo\n          avatar\n        }\n        authorization_level\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "UpdateUserManagersMutation",
...
// prettier-ignore
(node/*: any*/).hash = 'e8ce1216967e4e0a2cd5273e43f5da9a';
module.exports = node;
