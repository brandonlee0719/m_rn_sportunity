/**
 * @flow
 * @relayHash a3ae67a2e90e4757b560558e25462fe4
 */
...
export type DrawerContentRefetchQueryVariables = {||};
export type DrawerContentRefetchQueryResponse = {|
  +$fragmentRefs: DrawerContent_query$ref
|};
export type DrawerContentRefetchQuery = {|
  variables: DrawerContentRefetchQueryVariables,
  response: DrawerContentRefetchQueryResponse,
|};
*/
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "DrawerContentRefetchQuery",
  "id": null,
  "text": "query DrawerContentRefetchQuery {\n  ...DrawerContent_query\n}\n\nfragment DrawerContent_query on Query {\n  viewer {\n    me {\n      id\n      mangoId\n      profileType\n      isProfileComplete\n      birthday\n      numberOfFormsToFill\n      numberOfPaymentModelsToPay\n      ...DrawerWalletContainer_me\n      ...DrawerTeamsContainer_me\n      ...DrawerNotificationContainer_user\n      ...DrawerChatContainer_user\n      ...header_me\n    }\n    ...DrawerTeamsContainer_viewer\n    id\n  }\n}\n\nfragment DrawerWalletContainer_me on User {\n  id\n  isProfileComplete\n}\n\nfragment DrawerTeamsContainer_me on User {\n  id\n}\n\nfragment DrawerNotificationContainer_user on User {\n  id\n  numberOfUnreadNotifications\n  numberOfFormsToFill\n  numberOfPaymentModelsToPay\n}\n\nfragment DrawerChatContainer_user on User {\n  id\n}\n\nfragment header_me on User {\n  id\n  pseudo\n  avatar\n}\n\nfragment DrawerTeamsContainer_viewer on Viewer {\n  me {\n    id\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "DrawerContentRefetchQuery",
...
// prettier-ignore
(node/*: any*/).hash = '53be67d018565c9e4be63699885b46ef';
module.exports = node;
