...
declare export opaque type DrawerChatContainer_viewer$ref: FragmentReference;
export type DrawerChatContainer_viewer = {|
  +superMe?: ?{|
    +id: ?string,
    +pseudo: ?string,
    +avatar: ?string,
  ...
  +authorizedAccounts?: ?{|
    ...
    |}>,
  |},
  +$refType: DrawerChatContainer_viewer$ref,
|};
*/
...
// prettier-ignore
(node/*: any*/).hash = '234be20ed852bc27c62bfc486dccf42f';
module.exports = node;
